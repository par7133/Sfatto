...
switch ($url) {
  ...
  case "home":   
    ...
    if (defined("APP_HOME_PATH") && (APP_HOME_PATH !== PHP_STR) && is_readable(APP_HOME_PATH)) {
      ...
      define("SCRIPT_NAME", "detail");
      define("SCRIPT_FILENAME", "detail.php");   
  ...
  case "seastats":
    ...
    define("SCRIPT_NAME", "seastats");
    define("SCRIPT_FILENAME", "seastats.php");
  ...
  case "seaminer":
    ...
    define("SCRIPT_NAME", "seaminer");
    define("SCRIPT_FILENAME", "seaminer.php");
