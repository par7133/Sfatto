...
<!--<?PHP echo(APP_LICENSE);?>-->  
  ...
  <meta name="description" content="Welcome to Sfatto! Let everyone have its social status."/>
  <meta name="keywords" content="Sfatto,social,status,on,premise,solution,NuMode"/>
...
<?PHP if ($CURRENT_VIEW == ADMIN_VIEW): ?>    
  ...
  <body style="background:url('/res/bg1.jpg') no-repeat; background-size: cover; background-attachment: fixed; background-position: center;">
   <div id="AFHint" style="z-index:0;">
       ...
       <br>  
      <span onclick="showHowTo();"><?PHP echo(getResource0("How-to: Manage your avatars in Sfatto", $lang));?></span>
      <br><br>
   </div>     

  <form id="frmUpload" role="form" method="post" action="/detail/?hl=<?PHP echo($lang);?>" target="_self" enctype="multipart/form-data">  
...
<?php endif; ?>
   ...
   <div id="header" class="header" style="margin-top:18px;margin-bottom:18px;">
        <a href="http://sfatto.numode-foss.eu" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-5px;width:22px;">&nbsp;Sfatto</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/par7133/Sfatto" style="color:#000000;"><span style="color:#119fe2">on</span> github</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:code@gaox.io" style="color:#000000;"><span style="color:#119fe2">for</span> feedback</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:+39-378-0812391" style="font-size:13px;background-color:#15c60b;border:2px solid #15c60b;color:#000000;height:27px;text-decoration:none;">&nbsp;&nbsp;get support&nbsp;&nbsp;</a>
   </div>
   <div id="headerMob" class="header" style="margin-top:18px;margin-bottom:18px;display:none">
        <br><a href="http://sfatto.numode-foss.eu" target="_self" style="color:#000000; text-decoration: none;">&nbsp;<img src="/res/AFlogo.png" align="middle" style="position:relative;top:-5px;width:22px;">&nbsp;Sfatto</a>
   </div>
   ...
   <div id="title"> 
        ...
        <div id="cvs">  
                   ...
                   <div style="float:left;width:47px;margin-top:20px;margin-left:7px;margin-right:40px"><?PHP echo(getResource0("Spec", $lang));?></div>
       ...
       if (empty($aFilePaths)): ?>
         ...
         if (empty($aFilePaths)): ?>
                      ...
                      <?PHP else: ?>
                       <a href="/doc?av=<?PHP echo(AVATAR_NAME);?>&re=cv&doc=<?PHP echo(basename($aFilePaths[0]));?>"><img class="cv-entry" style="margin-top:27px;" src="/res/wordicon.png"></a>&nbsp;&nbsp;
                      <?PHP endif; ?>
                    <?PHP
         ...
         if (empty($aFilePaths)): ?>
                        ...
                        <?PHP else: ?>
                        <a href="/doc?av=<?PHP echo(AVATAR_NAME);?>&re=cv&doc=<?PHP echo(basename($aFilePaths[0]));?>"><img class="cv-entry" style="margin-top:0px" src="/res/pdficon.png"></a>
                      <?PHP endif; ?>
            <?PHP endif; ?>
       </div>  
   </div> 
 ...
 <div id="blog">    
   ...
   if (empty($aFilePaths)): ?>
            <div class="blog-content"> 
              <div class="blog-entry">  
                <?PHP echo(getResource0("Hello from NuMode", $lang));?>,<br>
                <?PHP echo(getResource0("This is just an example of avatar status", $lang));?>.
              </div> 
             </div>  
        <?PHP else: ?>
                <?PHP
      ...
      foreach ($aFilePaths as $filePath) {
        ...
        $date=substr(basename($filePath), 0 ,15);
        $date=substr(basename($filePath), 0 ,4)."-".substr(basename($filePath), 4 ,2)."-".substr(basename($filePath), 6 ,2)." ".substr(basename($filePath), 9 ,2).":".substr(basename($filePath), 11 ,2).":".substr(basename($filePath), 13 ,2); 
        ...
        ?>
                          <div class="blog-content" style="margin-bottom:<?PHP echo($marginbottom);?>;"> 
                           <div class="blog-entry" style="width:100%;margin-bottom:0px;">  
                             <?PHP echo($date . " uploaded status<br><br>");?>
   ...
   <div style="text-align:center;">
     <a href="/detail/?blogSP=<?PHP echo($firstPost);?>"><img src="/res/first.png" style="width:45px;"></a>
     <a href="/detail/?blogSP=<?PHP echo($prevPost);?>"><img src="/res/arrow-left2.png" style="width:45px;"></a>
     <a href="/detail/?blogSP=<?PHP echo($nextPost);?>"><img src="/res/arrow-right2.png" style="width:45px;"></a>
     <a href="/detail/?blogSP=<?PHP echo($lastPost);?>"><img src="/res/last.png" style="width:45px;"></a>
   </div>  
 ...
 <div id="friends">    
  ...
  <div id="footer">
    ...
    <span style="background:#FFFFFF; opacity:0.7;">&nbsp;&nbsp;A <a href="http://numode.eu" class="aaa">NuMode</a> project and <a href="http://demo.numode.eu" class="aaa">WYSIWYG</a> system. <?PHP echo(getResource0("CC", $lang));?></span></div>
